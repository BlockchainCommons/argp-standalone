% argp-standalone(SECTION) | User Commands
%
% "January 29 2023"
...
argp-standalone - program to do something

# SYNOPSIS

**argp-standalone** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**argp-standalone** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **argp-standalone** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**argp-standalone** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    argp-standalone. See **foo.conf**(5) for further details.
...
**argp-standalone** provides some return codes, that can be used in scripts:
